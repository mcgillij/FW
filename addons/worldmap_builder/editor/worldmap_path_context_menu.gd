...
static func _get_path_context_menu_callbacks(marker_index : int, obj : FW_WorldmapPath) -> Array[Callable]:
    match marker_index:
        0:
            return [
                (func(x):
