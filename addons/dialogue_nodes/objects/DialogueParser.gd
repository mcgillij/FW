...
@icon('res://addons/dialogue_nodes/icons/FW_DialogueParser.svg')
class_name FW_DialogueParser
extends Node
...
@export var data : FW_DialogueData :
    ...
    set(value):
        ...
        variables.clear()
        if not data is FW_DialogueData: return
        ...
        if not character_list is FW_CharacterList: return
...
func load_data(path : String):
    ...
    if not new_data is FW_DialogueData: return
