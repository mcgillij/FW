...
func create_entry(file_name : String, path : String, data : FW_DialogueData):
...
func open_file(path : String):
    ...
    if editor._debug:
        FW_Debug.debug_log(['File opened: ', path])
...
func save_file(idx := cur_idx):
    ...
    var data : FW_DialogueData = metadata['graph'].get_data()
    if idx == cur_idx:
    ...
    if editor._debug:
        FW_Debug.debug_log(['File saved: ', metadata['path']])
...
func save_as(path : String):
    ...
    if editor._debug:
        FW_Debug.debug_log(['File saved as: ', path])
...
func close_file(idx := cur_idx):
    ...
    if editor._debug:
        FW_Debug.debug_log(['File closed: ', metadata['path']])
